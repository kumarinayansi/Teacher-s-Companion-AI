        ...
        <form className="auth-form" id="auth-form" noValidate onSubmit={handleSignup}>
          ...
          <div className="form-group" id="fg-password">
            ...
            <div className="input-wrapper">
              ...
              <input type={showPassword ? "text" : "password"} id="password" name="password" className="form-input" placeholder="Create a password (min. 6 characters)" autoComplete="new-password" required value={password} onChange={(e) => setPassword(e.target.value)} />
